...
switch mcaformat
    ...
    case 'pilatus'
        ...
        for spectra = 1:nspectra 
            ...
            %KDF, Jan 2013
            bkgd = sum(foo(short_axis_bkgd, long_axis_range), 1);
